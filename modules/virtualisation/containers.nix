          ...
          binds = mkOption {
            ...
            type = lazyAttrsOfSubmodule {
              ...
              permissions = mkOption {
                ...
                example = "a+rx";
                description = ''
                  The permissions of the mount bind. The format is that of a
      ...
      config = {
        ...
        system.activationScripts."create-container-bind-mounts-dirs" =
          ...
          |> map (bind: ''
            ...
            chmod ${bind.permissions} ${bind.hostPath}
          '')
          |> concatStringsSep "\n";
        ...
        networking.nat = {
          ...
          externalInterface = lib.mkDefault (
            config.networking.interfaces |> lib.attrNames |> lib.findFirst (_: true) null
          );
        };

        # Set NAT external interface to `eth0` when running as a VM
        virtualisation.vmVariant.networking.nat.externalInterface = "eth0";
